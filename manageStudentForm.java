...
public class manageStudentForm extends JFrame {
	...
	public manageStudentForm()
	{
		...
		setResizable(false);
		setBounds(new Rectangle(800, 300, 1000, 600));
		...
		JLabel Student_heading = new JLabel("MANAGE STUDENTS");
		Student_heading.setBounds(175, 0, 279, 35);
		...
		id_text.setBounds(199, 35, 249, 24);
		panel.add(id_text);
		...
		f_text.setBounds(199, 70, 249, 28);
		panel.add(f_text);
		...
		d_text.setBounds(198, 201, 256, 28);
		panel.add(d_text);
		...
		p_text.setBounds(198, 255, 256, 28);
		panel.add(p_text);
		...
		radio_female.setBounds(341, 152, 110, 23);
		panel.add(radio_female);
		
		l_text = new JTextField();
		l_text.setColumns(10);
		l_text.setBounds(199, 109, 249, 25);
		panel.add(l_text);
		...
		submit.setBounds(341, 407, 117, 42);
		...
		edit_btn.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		edit_btn.setBounds(192, 407, 117, 42);
		panel.add(edit_btn);
		
		//table = new JTable();
		//table.setBounds(499, 34, 435, 415);
		//panel.add(table);
		
		   
		          
		   table=new JTable();
		   table.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Student detail", TitledBorder.CENTER, TitledBorder.BELOW_TOP, null, new Color(0, 0, 0)));
		   table.setBounds(499, 34, 435, 415);
			panel.add(table);         
